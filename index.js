                ...
                //if (message.webhookID != null 
                  //  && message.member.hasPermission("MANAGE_MESSAGES")) {
                    ...
                    if(message.webhookID) {
                        ...
                        message.channel.fetchMessages({limit: messagecount}).then(messages1 => {console.log(messages1.size + ', ' + messages1.values().next().delete()); bot.sweepMessages(5000)}/*message.channel.bulkDelete(messages1)*/);
                        /*
