...
>>>>>>> 40868e01d759e6d3577ec2858a5b5c68ea075d02
        ...
        if (message.webhookID) {
            ...
            message.channel.fetchMessages({ limit: messagecount }).then(messages1 => {
                console.log(messages1.size + ', ' + messages1.values().next())
                ; bot.sweepMessages(1)
            }/*message.channel.bulkDelete(messages1)*/);
            /*
            message.channel.fetchMessages()
                .then((messages1) => {
